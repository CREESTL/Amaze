...
interface IVesting {
    ...
    /// @notice Indicates that a new vesting has started
    ...
    /// @param claimablePeriod The period after cliff when users can claim their tokens
    ...
    function getVesting(uint256 id) external view returns (
        address, // to
        uint256, // amount
        uint256, // startTime
        uint256, // cliffDuration
    ...
    /// @param cliffUnlock Percentage of tokens unlocked right after the cliff
    /// @param claimablePeriod The period after cliff when users can claim their tokens
    ///        NOTE: This is *not* the whole duration of vesting period
